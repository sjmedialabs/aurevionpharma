...
export function ProductDetailHero() {
  return (
    <section className="relative h-[300px] w-full overflow-hidden">
      {/* Background Image */}
      <Image src="/images/products-hero.jpg" alt="Products" fill className="object-cover" priority />
      ...
      <div className="relative z-10 flex h-full items-center">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h2 className="mb-4 font-sans text-sm font-semibold uppercase tracking-wider text-primary">PRODUCTS</h2>
